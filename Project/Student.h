...
public:
    ...
    Student(const std::string& studentID, const std::string& password) : studentID(studentID), password(password), name(Name()), studentGender(false), birthDay(Date()), socialID("") {}
